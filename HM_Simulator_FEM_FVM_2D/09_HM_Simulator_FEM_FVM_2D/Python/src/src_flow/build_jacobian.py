...
from src.src_flow.add_wells import add_wells
from src.src_flow.phiCalc import phiCalc

from scipy.sparse import diags

def build_jacobian(Flow,Gen,State,trans,Wells):
    ...
    Acc = (dRhodP * phi + Rho * dphidP) * V / Gen["tstep"]
    ...
    # =============================================================================
    # Add derivatives of source terms
    # =============================================================================

    _, dQdP = add_wells(Flow,State,Wells)
